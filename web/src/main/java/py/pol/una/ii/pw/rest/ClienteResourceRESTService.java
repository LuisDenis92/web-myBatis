...
public class ClienteResourceRESTService {
    ...
    public List<Clientes> listAllClientes() throws IOException {
    ...
    @Path("/{id:[0-9][0-9]*}")
    @Produces(MediaType.APPLICATION_JSON)
    public Clientes lookupClienteById(@PathParam("id") long id) throws IOException {
        Clientes cliente = repository.getClienteById(id);
        if (cliente == null) {
  ...
  //  @Produces(MediaType.APPLICATION_JSON)
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Path("/crear")
    public void createCliente(@RequestBody Clientes cliente) throws IOException  {
    ...
    public void removeProvider(@PathParam("id")Long id,
        ...
        servletResponse.sendRedirect(index+"clientesList.jsf");
    }
